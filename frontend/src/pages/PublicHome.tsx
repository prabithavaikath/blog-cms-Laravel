        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <a href="#subscribe" className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-brand-600 via-accent-600 to-info-500 px-4 py-2 text-sm font-semibold text-white shadow-soft hover:opacity-95">Subscribe</a>
            </div>
